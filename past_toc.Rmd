...
dryso2 <- raster::stack("Sdep/dryso2_aero_NorESM1-ME_historical_r1i1p1_185001-200512.nc", bands = c(1549:1560)) %>% mean()
...
wr.sf.exp <- merge(wr.sf.past.mercator, st_drop_geometry(wr.basins), by = "gid")
...
ggplot(basins.exp)+geom_point(aes(x=year, y = yearlyTOC.Tg, col = sea))+theme_minimal()
```