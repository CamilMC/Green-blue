...
wr.sf.1899$TOC.export <- with(wr.sf.1899, TOC.fit*runoff) * 365 * 60 * 60 * 1e6 # mg/m2/s to mg/m2/year
...
wr.sf.1909$TOC.export <- with(wr.sf.1909, TOC.fit*runoff) * 365 * 60 * 60 * 1e6 # mg/m2/s to mg/m2/year
...
wr.sf.1919$TOC.export <- with(wr.sf.1919, TOC.fit*runoff) * 365 * 60 * 60 * 1e6 # mg/m2/s to mg/m2/year
...
wr.sf.1929$TOC.export <- with(wr.sf.1929, TOC.fit*runoff) * 365 * 60 * 60 * 1e6 # mg/m2/s to mg/m2/year
...
wr.sf.1939$TOC.export <- with(wr.sf.1939, TOC.fit*runoff) * 365 * 60 * 60 * 1e6 # mg/m2/s to mg/m2/year
...
wr.sf.1949$TOC.export <- with(wr.sf.1949, TOC.fit*runoff) * 365 * 60 * 60 * 1e6 # mg/m2/s to mg/m2/year
...
wr.sf.1959$TOC.export <- with(wr.sf.1959, TOC.fit*runoff) * 365 * 60 * 60 * 1e6 # mg/m2/s to mg/m2/year
...
wr.sf.1969$TOC.export <- with(wr.sf.1969, TOC.fit*runoff) * 365 * 60 * 60 * 1e6 # mg/m2/s to mg/m2/year
...
wr.sf.1979$TOC.export <- with(wr.sf.1979, TOC.fit*runoff) * 365 * 60 * 60 * 1e6 # mg/m2/s to mg/m2/year
...
wr.sf.1989$TOC.export <- with(wr.sf.1989, TOC.fit*runoff) * 365 * 60 * 60 * 1e6 # mg/m2/s to mg/m2/year
...
wr.sf.1999$TOC.export <- with(wr.sf.1999, TOC.fit*runoff) * 365 * 60 * 60 * 1e6 # mg/m2/s to mg/m2/year
...
```{r create-common-df, eval = F}
wr.sf <- readRDS("wr.sf.rds")
basins <- st_read("basins_all_sea.shp")

wr.sf.1899 <- readRDS("wr.sf.1899.rds")
wr.sf.1899$year <- "1899"

wr.sf.1909 <- readRDS("wr.sf.1909.rds")
wr.sf.1909$year <- "1909"

wr.sf.1919 <- readRDS("wr.sf.1919.rds")
wr.sf.1919$year <- "1919"

wr.sf.1929 <- readRDS("wr.sf.1929.rds")
wr.sf.1899$year <- "1899"

wr.sf.1939 <- readRDS("wr.sf.1939.rds")
wr.sf.1949 <- readRDS("wr.sf.1949.rds")
wr.sf.1959 <- readRDS("wr.sf.1959.rds")
wr.sf.1969 <- readRDS("wr.sf.1969.rds")
wr.sf.1979 <- readRDS("wr.sf.1979.rds")
wr.sf.1989 <- readRDS("wr.sf.1989.rds")
wr.sf.1999 <- readRDS("wr.sf.1999.rds")
