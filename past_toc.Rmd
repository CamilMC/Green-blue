...
cod.sum <- cod.table %>% group_by(Lat, Lon, Year) %>% summarise(TOC = mean(as.numeric(COD), na.rm = T))
...
decade.toc <- merged.rivers %>% group_by(Lon,Lat,decade) %>% summarise(TOC.decade = mean(as.numeric(TOC)))
